...
This project is a low-poly 3D level designed in Unity, featuring an innovative transportation mechanism and engaging gameplay areas. The level is divided into two main parts: the tram station where the character is born and a complex maze where the main activities occur.
...
- **Transportation**: Characters use a tram to travel from the tram station to the maze, integrating movement and exploration seamlessly into the gameplay.
...
- **Design**: The maze is designed with multiple pathways and challenges that test the player's problem-solving skills and dexterity.
...
- **Animated Tram**: The tram animates between the station and the maze, offering a dynamic element to the transportation (animation not fully implemented yet).
- **Interactive Elements**: Both the tram station and the maze feature interactive elements such as doors, switches, and moving platforms.

## Unsolved Issues

1. **Tram Animation**: The moving tram animation needs to be fully implemented to automate the transition between the tram station and the maze.
